...
resource "aws_iam_policy" "ecs_service_elb" {
  name        = "${var.application_name}-${var.environment}-dev-to-elb"
  path        = "/"
...
resource "aws_iam_policy" "ecs_service_standard" {
  name        = "${var.application_name}-${var.environment}-dev-to-standard"
  path        = "/"
...
resource "aws_iam_policy" "ecs_service_scaling" {
  name        = "${var.application_name}-${var.environment}-dev-to-scaling"
  path        = "/"
